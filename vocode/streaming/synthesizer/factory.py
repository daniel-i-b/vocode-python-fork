...
from vocode.streaming.synthesizer.play_ht_turbo_synthesizer import PlayHtTurboSynthesizer
...
class SynthesizerFactory:
    def create_synthesizer(
        ...
        elif isinstance(synthesizer_config, PlayHtTurboSynthesizerConfig):
            return PlayHtTurboSynthesizer(
                synthesizer_config, logger=logger, aiohttp_session=aiohttp_session
            )
        else:
